...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('participant_1_id', sa.Integer, sa.ForeignKey('participant.id'), nullable=False),
        sa.Column('participant_2_id', sa.Integer, sa.ForeignKey('participant.id'), nullable=False),
