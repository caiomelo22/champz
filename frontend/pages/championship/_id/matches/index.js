...
export default {
    ...
    methods: {
        ...
        async delete_group(group_id) {
            await this.$axios.delete(`championship/${this.championshipId}/group/delete/${group_id}`);
        },
        ...
        async create_group_stage() {
            await this.$axios
                .post(`championship/${this.championshipId}/group/create`)
        ...
        async get_group_stage() {
            await this.$axios
                .get(`championship/${this.championshipId}/group/get`)
                .then((response) => {
        ...
        async get_matches(group_id, round) {
            await this.$axios
                .get(`championship/${this.championshipId}/group/matches/${group_id}?round=${round}`)
                .then((response) => {
        ...
        async get_table(id) {
            await this.$axios
                .get(`championship/${this.championshipId}/group/table/${id}`)
                .then((response) => {
        ...
        async generate_knockouts() {
            ...
            await this.$axios
                .post(`championship/${this.championshipId}/group/generate-knockout`, body)
                .then(async (response) => {
