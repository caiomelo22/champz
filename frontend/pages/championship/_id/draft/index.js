...
export default {
    ...
    async created() {
        await this.get_championship();
        await this.get_participants();
        await this.get_most_popular_teams();
        await this.get_positions();
    },
    methods: {
        async get_championship() {
            try {
                const response = await this.$axios.get(`championship/${this.championshipId}`);
                this.championshipName = response.data.name;
                this.genericBudget = response.data.budget_default;
            } catch {
        ...
        async get_participants() {
            ...
            await this.$axios
                .get(`championship/${this.championshipId}/participant/list`)
                .then((response) => {
        ...
        async get_players_by_position_algorithm(idPosition) {
            this.playersLoading = true;
            await this.$axios
                .get(`championship/${this.championshipId}/player/list?position=${idPosition}`)
                .then((response) => {
        ...
        async get_players_by_team(participant, teamName) {
            ...
            await this.$axios
                .get(`championship/${this.championshipId}/player/list?participant_id=${participant.id}`)
                .then((response) => {
        ...
        async delete_participant(id) {
            let url = `championship/${this.championshipId}/participant/delete/${id}`;
        ...
        async remove_buy(player) {
            ...
            await this.$axios
                .post(`championship/${this.championshipId}/player/buy/${player.id}`, { participant_id: null })
                .then((response) => {
